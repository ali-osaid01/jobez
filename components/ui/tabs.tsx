...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'flex min-h-10 w-full max-w-full items-center justify-start gap-1 overflow-x-auto rounded-md bg-muted p-1 text-muted-foreground sm:inline-flex sm:w-auto sm:justify-center',
      className,
    )}
    {...props}
  />
