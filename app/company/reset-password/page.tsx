...
import CompanyResetForm from "@/components/forms/company/reset-password/reset.form";
        ...
        <div className="fixed top-0 left-0 w-1/2 h-screen flex flex-col justify-center items-start px-12 lg:px-16">
          ...
          <div className="relative z-10 mt-24 max-w-lg space-y-6 animate-fadeIn">
            ...
            <p className="text-[17px] text-gray-600 leading-relaxed">
              Set a new secure password for your company account to continue
              managing hiring and applicants safely.
            </p>
